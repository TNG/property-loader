...
public class ErrorMessageSetupTest {
    ...
    public void testInitializeDE() throws Exception {
        ...
        assertEquals("Command Line Argumente konnten nicht verarbeitet werden.",errorMessageSetup.getString("commandLineException"));
    }
    ...
    public void testInitializeEN() throws Exception {
        ...
        errorMessageSetup.initialize("errors", propertyLoader);
        assertEquals("unable to parse command line arguments",errorMessageSetup.getString("commandLineException"));
    }
